  ...
  return (
    <section className="rounded-[30px] border border-white/10 bg-slate-900/70 p-4 sm:p-5">
      <div className="flex items-center justify-between gap-3 border-b border-white/10 pb-4">
        <div>
          <p className="text-xs uppercase tracking-[0.28em] text-slate-400">Seção final</p>
          <h2 className="mt-2 text-xl font-semibold text-white">Coca-Cola</h2>
          <p className="mt-1 text-sm text-slate-400">
            Cards especiais separados do álbum principal para você controlar à parte.
          </p>
        </div>
